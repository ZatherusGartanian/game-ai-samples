...
public class ResourceLoader {
    public static final String TILE_FRAME = "tile_frame.png";
    public static final String RED_TOKEN = "red_token.png";
    public static final String GREEN_TOKEN = "green_token.png";
    public static final String YELLOW_TOKEN = "yellow_token.png";
    public static final String UI_BACKGROUND = "blankUI.png";
    public static final String FORFEIT_BUTTON = "reset.png";
    public static final String NEXT_BUTTON = "start.png";
