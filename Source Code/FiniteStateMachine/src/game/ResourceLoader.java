...
public class ResourceLoader {
    ...
    public static final String POISON_TILE = "poison.png";
    public static final String WATER_TILE = "water.png";
    public static final String FOOD_TILE = "food.png";
    public static final String ANT_HILL = "anthill.png";
    public static final String ANT = "ant_sheet_death.png";
    public static final String UI = "blankUI.png";
    ...
    public static final String FOOD_THOUGHT = "food_thought.png";
    public static final String WATER_THOUGHT = "water_thought.png";
    public static final String HOME_THOUGHT = "home_thought.png";
